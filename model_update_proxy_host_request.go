...
// GetTrustForwardedProto returns the TrustForwardedProto field value if set, zero value otherwise.
func (o *UpdateProxyHostRequest) GetTrustForwardedProto() bool {
	if o == nil || IsNil(o.TrustForwardedProto) {
		var ret bool
		return ret
	}
	return *o.TrustForwardedProto
}

// GetTrustForwardedProtoOk returns a tuple with the TrustForwardedProto field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateProxyHostRequest) GetTrustForwardedProtoOk() (*bool, bool) {
	if o == nil || IsNil(o.TrustForwardedProto) {
		return nil, false
	}
	return o.TrustForwardedProto, true
}
...
// SetTrustForwardedProto gets a reference to the given bool and assigns it to the TrustForwardedProto field.
func (o *UpdateProxyHostRequest) SetTrustForwardedProto(v bool) {
	o.TrustForwardedProto = &v
}
...
func (o UpdateProxyHostRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TrustForwardedProto) {
		toSerialize["trust_forwarded_proto"] = o.TrustForwardedProto
	}
...
func (o *UpdateProxyHostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UpdateProxyHostRequest(varUpdateProxyHostRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "trust_forwarded_proto")
