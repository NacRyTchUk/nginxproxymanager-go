...
// GetTrustForwardedProto returns the TrustForwardedProto field value
...
// GetTrustForwardedProtoOk returns a tuple with the TrustForwardedProto field value
// and a boolean to check if the value has been set.
...
// SetTrustForwardedProto sets field value
