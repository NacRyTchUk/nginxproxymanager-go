...
func (r ApiGetSettingRequest) Execute() (*GetSettings200ResponseInner, *http.Response, error) {
...
func (a *SettingsAPIService) GetSettingExecute(r ApiGetSettingRequest) (*GetSettings200ResponseInner, *http.Response, error) {
	var (
...
func (r ApiUpdateSettingRequest) Execute() (*GetSettings200ResponseInner, *http.Response, error) {
...
//
//	@return GetSettings200ResponseInner
func (a *SettingsAPIService) UpdateSettingExecute(r ApiUpdateSettingRequest) (*GetSettings200ResponseInner, *http.Response, error) {
	var (
